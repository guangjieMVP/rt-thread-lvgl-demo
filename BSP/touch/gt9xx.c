...
// };
 ...
 const uint8_t CTP_CFG_GT911[] =  {
    0x42,0x20,0x03,0xE0,0x01,0x05,0x3D,0x20,0x22,0x08,0x28,
	0x08,0x5F,0x41,0x03,0x05,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x17,0x1A,0x1D,0x14,0x89,0x2A,0x09,0x99,0x9B,0xB2,
	0x04,0x00,0x00,0x00,0x22,0x01,0x1D,0x00,0x01,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x82,0xB4,0x9E,0xD5,
	0xF4,0x07,0x00,0x00,0x04,0x89,0x86,0x00,0x84,0x8F,0x00,
	0x7F,0x99,0x00,0x7B,0xA3,0x00,0x77,0xAE,0x00,0x77,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x10,0x12,0x14,
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xA3,0x01	
 };
...
int32_t GTP_TouchDataGet(void)
{
    return (((int32_t)pre_x) << 16) | pre_y;
}
...
static void GTP_Touch_Down(int32_t id, int32_t x, int32_t y, int32_t w)
{
	...
	printf("posx = %d posy = %d\r\n", touch_param[touchIC].max_width - pre_x, 
	                                  touch_param[touchIC].max_height - pre_y);
}
...
//	__enable_irq();
//	
////	if (pre_x >= touch_param[touchIC].max_width)
////		pre_x = touch_param[touchIC].max_width;
////	if (pre_y >= touch_param[touchIC].max_height)
////		pre_y = touch_param[touchIC].max_height;
////	
////	x = touch_param[touchIC].max_width - pre_x;
////	y = touch_param[touchIC].max_height - pre_y;
//	if((pre_x==-1) || (pre_y==-1))
////	if((x < 0) || (y < -1))
//	{
//		State.x = -1;
...
//	State.Layer = 0;
//	
//	GUI_PID_StoreState(&State);    //将触摸坐标提交给emwin
//}
